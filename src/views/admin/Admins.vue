...
<template>
  ...
  <div class="container">
    <el-form :inline="true" :model="searchUser" class="demo-form-inline">
      <el-form-item label="姓名">
        <el-input v-model="searchUser.name" placeholder="请输入管理员姓名" clearable />
      </el-form-item>
  ...
  <div class=container>
    <el-button type="primary" @click="">新增管理员</el-button>
  ...
  <div class="container">
    <el-table :data="user" border style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="identifier" label="管理员号" width="150" align="center" />
