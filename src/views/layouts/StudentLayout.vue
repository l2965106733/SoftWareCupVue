        ...
        <header class="modern-header">
            <div class="header-content">
                <div class="header-left">
                    ...
                    <router-link to="/student/practise" class="nav-item" active-class="active">
                        <i class="fas fa-tasks nav-icon"></i>
                        <span class="nav-text">作业模块</span>
                    </router-link>
                    <router-link to="/student/interact" class="nav-item" active-class="active">
                        <i class="fas fa-comments nav-icon"></i>
